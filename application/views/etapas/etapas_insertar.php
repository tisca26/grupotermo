            ...
            <div class="page-content-inner">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        ...
                        <?php echo form_open('etapas/insertar_etapa', array('id' => 'current_form')); ?>
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_dropdown('obras_id', $obras, set_value('obras_id'), 'id="obras_id" class="form-control bs-select" data-live-search="true" data-size="5" title="'.trans_line('obra_placeholder').'"'); ?>
