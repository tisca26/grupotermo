            ...
            <div class="page-content-inner">
                <div class="portlet light ">
                    <div class="portlet-body">
                        ...
                        <a href="<?php echo base_url_lang() . 'etapas/form_insert' ?>" class="btn btn-success btn_loading_page">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            <thead>
                            <tr>
                                <th> <?php echo trans_line('etapa_tabla'); ?></th>
                            ...
                            <?php foreach ($rows as $etapa): ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td> <?php echo $etapa->obra_nombre; ?></td>
                                    <td>
                                        <a href="<?php echo base_url_lang() . 'etapas/form_edit/' . $etapa->etapas_id ?>"
...
<script type="application/javascript">
    $(document).ready(function () {
        ...
        $('.delete_confirmation').on('confirmed.bs.confirmation', function () {
            ...
            window.location.href = "<?php echo base_url_lang() . 'etapas/borrar_etapa/' ?>" + id;
        });
    });// FIN DOCUMENT READY
</script>