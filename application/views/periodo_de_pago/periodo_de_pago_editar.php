    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="<?php echo base_url_lang() . 'periodo_de_pago'; ?>"><?php echo trans_line('breadcrumb_periodo_de_pago'); ?></a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <span><?php echo trans_line('breadcrumb_periodo_de_pago_editar'); ?></span>
                </li>
            </ul>
            ...
            <div class="page-content-inner">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        ...
                        <?php echo form_open('periodo_de_pago/editar_periodo_de_pago', array('id' => 'current_form')); ?>
                        <input type="hidden" name="periodo_de_pago_id" value="<?php echo $per->periodo_de_pago_id; ?>">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('nombre', set_value('nombre', $per->nombre), 'id="nombre" placeholder="' . trans_line('nombre') . '" class="form-control"'); ?>
