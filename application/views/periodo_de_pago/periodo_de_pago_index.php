    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <span><?php echo trans_line('breadcrumb_periodo_de_pago'); ?></span>
                </li>
            </ul>
            ...
            <div class="page-content-inner">
                <div class="portlet light ">
                    <div class="portlet-body">
                        ...
                        <a href="<?php echo base_url_lang() . 'periodo_de_pago/form_insert' ?>" class="btn btn-success">
                            <i class="fa fa-plus"></i> <?php echo trans_line('agregar_periodo_de_pago'); ?></a>
                        <hr>
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            <tbody>
                            <?php foreach ($rows as $per): ?>
                                <tr class="odd gradeX">
                                    <td> <?php echo $per->nombre; ?></td>
                                    <td>
                                        <a href="<?php echo base_url_lang() . 'periodo_de_pago/form_edit/' . $per->periodo_de_pago_id ?>"
                                        ...
                                        <a class="badge badge-danger badge-roundless delete_confirmation"
                                           ...
                                           data-id="<?php echo $per->periodo_de_pago_id ?>">
...
<script type="application/javascript">
    $(document).ready(function () {
        ...
        $('.delete_confirmation').on('confirmed.bs.confirmation', function () {
            ...
            window.location.href = "<?php echo base_url_lang() . 'periodo_de_pago/borrar_periodo_de_pago/' ?>" + id;
        });
    });// FIN DOCUMENT READY
</script>