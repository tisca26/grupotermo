    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <span><?php echo trans_line('breadcrumb_periodo_de_pago_agregar'); ?></span>
                </li>
            </ul>
            ...
            <div class="page-content-inner">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        ...
                        <?php echo form_open('periodo_de_pago/insertar_periodo_de_pago', array('id' => 'current_form')); ?>
                        <div class="form-body">
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a class="btn default"
                                       href="<?php echo base_url_lang() . 'periodo_de_pago' ?>">Regresar</a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close(); ?>
