    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <span><?php echo trans_line('breadcrumb_resources'); ?></span>
                </li>
            </ul>
            ...
            <div class="page-content-inner">
                <div class="portlet light ">
                    <div class="portlet-body">
                        ...
                        <a href="<?php echo base_url_lang() . 'resources/form_insert' ?>" class="btn btn-success">
                            <i class="fa fa-plus"></i> <?php echo trans_line('agregar_recurso'); ?></a>
                        <hr>
                            ...
                            <?php foreach ($rows as $rec): ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        <a class="badge badge-danger badge-roundless delete_confirmation" data-toggle="confirmation" data-placement="top"
                                           data-original-title="<?php echo trans_line('confirmacion_borrado_titulo'); ?>" data-btn-ok-label="<?php echo trans_line('confirmacion_borrado_ok'); ?>"
                                           data-btn-ok-icon="icon-like" data-btn-ok-class="btn-success" data-btn-cancel-label="<?php echo trans_line('confirmacion_borrado_cancel'); ?>"
                                           data-btn-cancel-icon="icon-close" data-btn-cancel-class="btn-danger" data-id="<?php echo $rec->ID ?>">
...
<script type="application/javascript">
    $(document).ready(function () {
        ...
        $('.delete_confirmation').on('confirmed.bs.confirmation', function () {
            ...
            window.location.href = "<?php echo base_url_lang() . 'resources/delete_resource/' ?>" + id;
        });
    });// FIN DOCUMENT READY
</script>