    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <span><?php echo trans_line('breadcrumb_users_editar'); ?></span>
                </li>
            </ul>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('nick', set_value('nick', $user->NICKNAME), 'id="nick" placeholder="' . trans_line('username_placeholder_usuario') . '" class="form-control"'); ?>
                                        ...
                                        <div class="md-checkbox-list">
                                            <div class="md-checkbox">
                                                <input type="checkbox" id="enableuser" name="enableuser" value="1"
                                                       class="md-check" <?php echo set_checkbox('enableuser', '1', (bool) $user->ENABLE); ?>>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('nombre', set_value('nombre', $user->NOMBRE), 'id="nombre" placeholder="' . trans_line('nombre_placeholder') . '" class="form-control"'); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('apellidos', set_value('apellidos', $user->APELLIDOS), 'id="apellidos" placeholder="' . trans_line('apellidos_placeholder') . '" class="form-control"'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('correo', set_value('correo', $user->EMAIL), 'id="correo" placeholder="' . trans_line('email_placeholder') . '" class="form-control"'); ?>
                                            ...
                                            <?php foreach ($groups as $gr): ?>
                                                <div class="md-radio">
                                                    <input type="radio" id="radio_group_<?php echo $gr->ID; ?>"
                                                           ...
                                                           class="md-radiobtn" <?php echo set_radio('radio_group', $gr->ID, (bool) ($usergroups->GROUPID == $gr->ID)); ?>>
