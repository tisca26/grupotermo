    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <span><?php echo trans_line('breadcrumb_users'); ?></span>
                </li>
            </ul>
            ...
            <div class="page-content-inner">
                <div class="portlet light ">
                    <div class="portlet-body">
                        ...
                        <a href="<?php echo base_url_lang() . 'users/form_insert' ?>" class="btn btn-success">
                            <i class="fa fa-plus"></i> <?php echo trans_line('agregar_usuario'); ?></a>
                        <hr>
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                               id="users_table">
                            <thead>
                            <tr>
                                <th> <?php echo trans_line('usuario_tabla'); ?></th>
                                <th> <?php echo trans_line('email_tabla'); ?></th>
                            ...
                            <tbody>
                            <?php foreach ($rows as $usr): ?>
                                <tr class="odd gradeX">
                                    <td> <?php echo $usr->NICKNAME; ?></td>
                                    <td> <?php echo $usr->EMAIL; ?></td>
                                    <td> <?php echo $usr->GRUPO; ?></td>
                                    <td> <i class="fa fa-<?php echo ($usr->ENABLE)? 'check' : 'close'; ?>"> </i></td>
                                    <td>
...
<script type="application/javascript">
    $(document).ready(function () {
        ...
        $('.delete_confirmation').on('confirmed.bs.confirmation', function () {
            ...
            window.location.href = "<?php echo base_url_lang() . 'users/delete_user/' ?>" + id;
        });
    });// FIN DOCUMENT READY
</script>