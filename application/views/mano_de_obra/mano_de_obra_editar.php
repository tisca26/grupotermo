    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="<?php echo base_url_lang() . 'mano_de_obra'; ?>"><?php echo trans_line('breadcrumb_pagina'); ?></a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
            ...
            <div class="page-content-inner">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        ...
                        <?php echo form_open('mano_de_obra/editar_mano', array('id' => 'current_form')); ?>
                        <input type="hidden" name="mano_de_obra_id" value="<?php echo $mano->mano_de_obra_id; ?>">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('nombre', set_value('nombre', $mano->nombre), 'id="nombre" placeholder="' . trans_line('nombre_placeholder') . '" class="form-control"'); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('precio_unitario', set_value('precio_unitario', $mano->precio_unitario), 'id="precio_unitario" placeholder="' . trans_line('precio_unitario_placeholder') . '" class="form-control"'); ?>
                                        ...
                                        <div class="md-checkbox-list">
                                            <div class="md-checkbox">
                                                <input type="checkbox" id="estatus" name="estatus" value="1"
                                                       class="md-check" <?php echo set_checkbox('estatus', '1', (bool) $mano->estatus); ?>>
                                                <label for="estatus">
                                                    <span></span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a class="btn default btn_loading_page"
                                       href="<?php echo base_url_lang() . 'mano_de_obra' ?>"><?php echo trans_line('btn_cancel'); ?></a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close(); ?>
