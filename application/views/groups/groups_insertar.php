    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <span><?php echo trans_line('breadcrumb_groups_agregar'); ?></span>
                </li>
            </ul>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('groupname', set_value('groupname'), 'id="groupname" placeholder="' . trans_line('groupname_placeholder') . '" class="form-control"'); ?>
                                        ...
                                        <div class="md-checkbox-list">
                                            <div class="md-checkbox">
                                                <input type="checkbox" id="enablegroup" name="enablegroup" value="1"
                                                       class="md-check" <?php echo set_checkbox('enablegroup', '1'); ?>>
