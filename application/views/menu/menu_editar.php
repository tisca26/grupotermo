    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <span><?php echo trans_line('breadcrumb_menu_editar'); ?></span>
                </li>
            </ul>
                    ...
                    <div class="portlet-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('name', set_value('name', $menu['name']), 'id="name" placeholder="' . trans_line('name_placeholder') . '" class="form-control"'); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('shortdesc', set_value('shortdesc', $menu['shortdesc']), 'id="shortdesc" placeholder="' . trans_line('shortdesc_placeholder') . '" class="form-control"'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_dropdown('parentid', $menus, $menu['parentid'], 'class="form-control"') ?>
                                        ...
                                        <div class="md-checkbox-list">
                                            <div class="md-checkbox">
                                                <input type="checkbox" id="status" name="status" value="1"
                                                       class="md-check" <?php echo set_checkbox('status', '1', $menu['status']); ?>>
                                                <label for="status">
                                                    <span></span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                        ...
                                        <div class="md-radio-inline">
                                            <div class="md-radio">
                                                <input type="radio" id="radio_res"
                                                       ...
                                                       class="md-radiobtn" <?php echo set_radio('radiourl', 0, $menu['radio_res']); ?>>
                                                <label for="radio_res">
                                                    <span></span>
                                                    <span class="inc"></span>
                                                    <span class="check"></span>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_dropdown('resource', $resources, $menu['resourceid'], 'id="resource" class="form-control"') ?>
                                        /<br/>
                                        <?php echo form_input('page_res', set_value('page_res', $menu['page_res']), 'id="page_res" placeholder="' . trans_line('resources_placeholder') . '" class="form-control"'); ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-md-radios">
                                        ...
                                        <div class="md-radio-inline">
                                            <div class="md-radio">
                                                <input type="radio" id="radio_url"
                                                       ...
                                                       class="md-radiobtn" <?php echo set_radio('radiourl', 1, $menu['radio_url']); ?>>
                                                <label for="radio_url">
                                                    <span></span>
                                                    <span class="inc"></span>
                                                    <span class="check"></span>
                                    ...
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('page_uri', set_value('page_uri', $menu['page_uri']), 'id="page_uri" placeholder="' . trans_line('page_uri_placeholder') . '" class="form-control"'); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('order', set_value('order', $menu['orderr']), 'id="order" placeholder="' . trans_line('order_placeholder') . '" class="form-control"'); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('icon', set_value('icon', $menu['icon']), 'id="icon" placeholder="' . trans_line('icono_placeholder') . '" class="form-control"'); ?>
