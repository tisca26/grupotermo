    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="<?php echo base_url_lang() . 'materiales'; ?>"><?php echo trans_line('breadcrumb_pagina'); ?></a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
            ...
            <div class="page-content-inner">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        ...
                        <?php echo form_open('materiales/editar_material', array('id' => 'current_form')); ?>
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('nombre', set_value('nombre', $material->nombre), 'id="nombre" placeholder="' . trans_line('nombre_placeholder') . '" class="form-control"'); ?>
                                        ...
                                        <div class="md-checkbox-list">
                                            <div class="md-checkbox">
                                                <input type="checkbox" id="estatus" name="estatus" value="1"
                                                       class="md-check" <?php echo set_checkbox('estatus', '1', (bool) $material->estatus); ?>>
                                                <label for="estatus">
                                                    <span></span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('precio_propio', set_value('precio_propio', $material->precio_propio), 'id="precio_propio" placeholder="' . trans_line('precio_propio_placeholder') . '" class="form-control"'); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_dropdown('unidades_id', $unidades, set_value('unidades_id', $material->unidades_id), 'id="unidades_id" title="' . trans_line('unidades_id_placeholder') . '" class="form-control bs-select" data-size="5" data-live-search="true" data-live-search-normalize="true"'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_dropdown('materiales_categoria_id[]', $categorias, $categorias_sel, 'id="materiales_categoria_id" title="' . trans_line('categoria_placeholder') . '" class="form-control bs-select" data-live-search="true" data-live-search-normalize="true" multiple'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a href="javascript:;" id="btn_agregar_proveedor" class="btn btn-success mt-repeater-add">
                            ...
                            <?php foreach ($precios as $precio): ?>
                                <div class="generated_div_proveedor row">
                                    <div class="col-md-2">
                                        <div class="form-group form-md-line-input">
                                            <input type="text" name="precio_unitario[<?php echo $cont; ?>]" value="<?php echo set_value('precio_unitario[]', $precio->precio_unitario); ?>" placeholder="<?php echo trans_line('precio_unitario_placeholder'); ?>" class="form-control precio_unitario" data-rule-required="true" data-msg-required="<?php echo trans_line('required'); ?>" data-rule-number="true" data-msg-number="<?php echo trans_line('number'); ?>">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group form-md-line-input">
                                            <input type="text" name="nombre_ubicacion[<?php echo $cont; ?>]" value="<?php echo set_value('nombre_ubicacion[]', $precio->nombre_ubicacion); ?>" placeholder="<?php echo trans_line('nombre_ubicacion_placeholder'); ?>" class="form-control nombre_ubicacion" data-rule-required="true" data-msg-required="<?php echo trans_line('required'); ?>">
                            ...
                            <div id="my_div_repeat">
                                <div id="my_repeat" class="generated_div_proveedor row">
                                    <div class="col-md-2">
                                        <div class="form-group form-md-line-input">
                                            <input type="text" name="precio_unitario[<?php echo $cont; ?>]" value="<?php echo set_value('precio_unitario[]'); ?>" placeholder="<?php echo trans_line('precio_unitario_placeholder'); ?>" class="form-control precio_unitario" data-rule-required="true" data-msg-required="<?php echo trans_line('required'); ?>" data-rule-number="true" data-msg-number="<?php echo trans_line('number'); ?>">
                                            <label for="precio_unitario"><?php echo trans_line('precio_unitario'); ?>
                                                <span class="required">*</span>
                                            </label>
                                            <span class="help-block"><?php echo trans_line('precio_unitario_ayuda'); ?></span>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group form-md-line-input">
                                            <input type="text" name="nombre_ubicacion[<?php echo $cont; ?>]" value="<?php echo set_value('nombre_ubicacion[]'); ?>" placeholder="<?php echo trans_line('nombre_ubicacion_placeholder'); ?>" class="form-control nombre_ubicacion" data-rule-required="true" data-msg-required="<?php echo trans_line('required'); ?>">
                                            <label for="precio_unitario"><?php echo trans_line('nombre_ubicacion'); ?>
                                                <span class="required">*</span>
                                            </label>
                                            <span class="help-block"><?php echo trans_line('nombre_ubicacion_ayuda'); ?></span>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a class="btn default btn_loading_page"
                                       href="<?php echo base_url_lang() . 'materiales' ?>"><?php echo trans_line('btn_cancel'); ?></a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close(); ?>
...
//        jQuery.validator.addClassRules("precio_unitario", {
//            number: true,
//            required: true
//        });
