            ...
            <div class="page-content-inner">
                <div class="portlet light ">
                    <div class="portlet-body">
                        ...
                        <a href="<?php echo base_url_lang() . 'materiales/form_insert' ?>" class="btn btn-success btn_loading_page">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            <?php foreach ($rows as $material): ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="<?php echo base_url_lang() . 'materiales/form_edit/' . $material->materiales_id ?>"
...
<script type="application/javascript">
    $(document).ready(function () {
        ...
        $('.delete_confirmation').on('confirmed.bs.confirmation', function () {
            ...
            window.location.href = "<?php echo base_url_lang() . 'materiales/borrar_material/' ?>" + id;
        });
    });// FIN DOCUMENT READY
</script>