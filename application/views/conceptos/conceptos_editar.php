    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="<?php echo base_url_lang() . 'conceptos'; ?>"><?php echo trans_line('breadcrumb_pagina'); ?></a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
            ...
            <div class="page-content-inner">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        ...
                        <?php echo form_open('conceptos/editar_concepto', array('id' => 'current_form')); ?>
                        <input type="hidden" name="conceptos_id" value="<?php echo $concepto->conceptos_id; ?>">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('nombre', set_value('nombre', $concepto->nombre), 'id="nombre" placeholder="' . trans_line('nombre_placeholder') . '" class="form-control"'); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_dropdown('obras_id', $obras, $concepto->obras_id, 'id="obras_id" class="form-control bs-select" data-live-search="true" title="'.trans_line('obra_placeholder').'"'); ?>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a class="btn default"
                                       href="<?php echo base_url_lang() . 'conceptos' ?>"><?php echo trans_line('btn_cancel'); ?></a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close(); ?>
