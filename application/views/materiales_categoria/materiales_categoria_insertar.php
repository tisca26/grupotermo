            ...
            <div class="page-content-inner">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        ...
                        <?php echo form_open('materiales_categoria/insertar_material_categoria', array('id' => 'current_form')); ?>
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('descripcion', set_value('descripcion'), 'id="descripcion" placeholder="' . trans_line('descripcion_placeholder') . '" class="form-control"'); ?>
