            ...
            <div class="page-content-inner">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        ...
                        <?php echo form_open('activos/insertar_activo', array('id' => 'current_form')); ?>
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('precio_propio', set_value('precio_propio', 0), 'id="precio_propio" placeholder="' . trans_line('precio_propio_placeholder') . '" class="form-control"'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('clave', set_value('clave'), 'id="clave" placeholder="' . trans_line('clave_placeholder') . '" class="form-control"'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('capacidad_carga', set_value('capacidad_carga'), 'id="capacidad_carga" placeholder="' . trans_line('capacidad_carga_placeholder') . '" class="form-control"'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_dropdown('activos_categoria_id[]', $categorias, set_value('activos_categoria_id'), 'id="activos_categoria_id" title="' . trans_line('categoria_placeholder') . '" class="form-control bs-select" data-size="5" data-live-search="true" data-live-search-normalize="true" multiple'); ?>
