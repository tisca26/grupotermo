            ...
            <div class="page-content-inner">
                <div class="portlet light ">
                    <div class="portlet-body">
                        ...
                        <a href="<?php echo base_url_lang() . 'activos/form_insert' ?>" class="btn btn-success btn_loading_page">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            <tbody>
                            <?php foreach ($rows as $activo): ?>
                                <tr class="odd gradeX">
                                    <td> <?php echo $activo->nombre; ?></td>
                                    <td>
                                        <a href="<?php echo base_url_lang() . 'activos/form_edit/' . $activo->activos_id ?>"
                                        ...
                                        <a class="badge badge-danger badge-roundless delete_confirmation"
                                           ...
                                           data-id="<?php echo $activo->activos_id ?>">
...
<script type="application/javascript">
    $(document).ready(function () {
        ...
        $('.delete_confirmation').on('confirmed.bs.confirmation', function () {
            ...
            window.location.href = "<?php echo base_url_lang() . 'activos/borrar_activo/' ?>" + id;
        });
    });// FIN DOCUMENT READY
</script>