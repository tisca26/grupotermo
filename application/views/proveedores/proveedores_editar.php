    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="<?php echo base_url_lang() . 'proveedores'; ?>"><?php echo trans_line('breadcrumb_proveedores'); ?></a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <span><?php echo trans_line('breadcrumb_proveedores_editar'); ?></span>
                </li>
            </ul>
            ...
            <div class="page-content-inner">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        ...
                        <?php echo form_open('proveedores/editar_proveedor', array('id' => 'current_form')); ?>
                        <input type="hidden" name="proveedores_id" value="<?php echo $prov->proveedores_id; ?>">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('razon_social', set_value('razon_social', $prov->razon_social), 'id="razon_social" placeholder="' . trans_line('razon_social_placeholder') . '" class="form-control"'); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('rfc', set_value('rfc', $prov->rfc), 'id="rfc" placeholder="' . trans_line('rfc_placeholder') . '" class="form-control"'); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('email', set_value('email', $prov->email), 'id="email" placeholder="' . trans_line('email_placeholder') . '" class="form-control"'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('direccion', set_value('direccion', $prov->direccion), 'id="direccion" placeholder="' . trans_line('direccion_placeholder') . '" class="form-control"'); ?>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a class="btn default"
                                       href="<?php echo base_url_lang() . 'proveedores' ?>">Regresar</a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close(); ?>
