                ...
                <div class="portlet light ">
                    <div class="portlet-body">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            <thead>
                            <tr>
                                <th> <?php echo trans_line('empresa_tabla'); ?></th>
                            ...
                            <?php foreach ($rows as $cli): ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="<?php echo base_url_lang() . 'empresas/form_edit/' . $cli->empresas_id ?>"
                                        ...
                                        <a class="badge badge-danger badge-roundless delete_confirmation"
                                           ...
                                           data-id="<?php echo $cli->empresas_id ?>">
...
<script type="application/javascript">
    $(document).ready(function () {
        ...
        $('.delete_confirmation').on('confirmed.bs.confirmation', function () {
            ...
            window.location.href = "<?php echo base_url_lang() . 'empresas/borrar_empresa/' ?>" + id;
        });
    });// FIN DOCUMENT READY
</script>