    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="<?php echo base_url_lang() . 'servicios_categoria'; ?>"><?php echo trans_line('breadcrumb_pagina'); ?></a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
            ...
            <div class="page-content-inner">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        ...
                        <?php echo form_open('servicios_categoria/editar_servicio_categoria', array('id' => 'current_form')); ?>
                        <input type="hidden" name="servicios_categoria_id" value="<?php echo $servicio_categoria->servicios_categoria_id; ?>">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('nombre', set_value('nombre', $servicio_categoria->nombre), 'id="nombre" placeholder="' . trans_line('nombre_placeholder') . '" class="form-control"'); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('descripcion', set_value('descripcion', $servicio_categoria->descripcion), 'id="descripcion" placeholder="' . trans_line('descripcion_placeholder') . '" class="form-control"'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a class="btn default btn_loading_page"
                                       href="<?php echo base_url_lang() . 'servicios_categoria' ?>"><?php echo trans_line('btn_cancel'); ?></a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close(); ?>
