            ...
            <div class="page-content-inner">
                <div class="portlet light ">
                    <div class="portlet-body">
                        ...
                        <a href="<?php echo base_url_lang() . 'servicios_categoria/form_insert' ?>" class="btn btn-success btn_loading_page">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            <thead>
                            <tr>
                                <th> <?php echo trans_line('servicio_tabla'); ?></th>
                                <th> <?php echo trans_line('acciones_tabla'); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php foreach ($rows as $servicio_categoria): ?>
                                <tr class="odd gradeX">
                                    <td> <?php echo $servicio_categoria->nombre; ?></td>
                                    <td>
                                        <a href="<?php echo base_url_lang() . 'servicios_categoria/form_edit/' . $servicio_categoria->servicios_categoria_id ?>"
                                        ...
                                        <a class="badge badge-danger badge-roundless delete_confirmation"
                                           ...
                                           data-id="<?php echo $servicio_categoria->servicios_categoria_id ?>">
...
<script type="application/javascript">
    $(document).ready(function () {
        ...
        $('.delete_confirmation').on('confirmed.bs.confirmation', function () {
            ...
            window.location.href = "<?php echo base_url_lang() . 'servicios_categoria/borrar_servicio_categoria/' ?>" + id;
        });
    });// FIN DOCUMENT READY
</script>