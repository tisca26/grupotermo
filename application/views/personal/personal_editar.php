                    ...
                    <div class="portlet-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('precio_propio', set_value('precio_propio', $activo->precio_propio), 'id="precio_propio" placeholder="' . trans_line('precio_propio_placeholder') . '" class="form-control"'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('clave', set_value('clave', $activo->clave), 'id="clave" placeholder="' . trans_line('clave_placeholder') . '" class="form-control"'); ?>
                                        <label for="clave"><?php echo trans_line('clave'); ?>
                                            <span class="required">*</span>
                                        </label>
                                        <span class="help-block"><?php echo trans_line('clave_ayuda'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <div class="md-checkbox-list">
                                            <div class="md-checkbox">
                                                <input type="checkbox" id="estatus" name="estatus" value="1"
                                                       class="md-check" <?php echo set_checkbox('estatus', '1', (bool) $activo->estatus); ?>>
                                                <label for="estatus">
                                                    <span></span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('capacidad_carga', set_value('capacidad_carga', $activo->capacidad_carga), 'id="capacidad_carga" placeholder="' . trans_line('capacidad_carga_placeholder') . '" class="form-control"'); ?>
                                        <label for="nombre"><?php echo trans_line('capacidad_carga'); ?>
                                        </label>
                                        <span class="help-block"><?php echo trans_line('capacidad_carga_ayuda'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_dropdown('unidades_id', $unidades, set_value('unidades_id', $activo->unidades_id), 'id="unidades_id" title="' . trans_line('unidades_id_placeholder') . '" class="form-control bs-select" data-size="5" data-live-search="true" data-live-search-normalize="true"'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_dropdown('activos_categoria_id[]', $categorias, $categorias_sel, 'id="activos_categoria_id" title="' . trans_line('categoria_placeholder') . '" class="form-control bs-select" data-live-search="true" data-live-search-normalize="true" multiple'); ?>
