            ...
            <div class="page-content-inner">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        ...
                        <?php echo form_open_multipart('personal/editar_personal', array('id' => 'current_form')); ?>
                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-2">
                                    <?php if ($personal->foto_personal != ''): ?>
                                        <img src="<?php echo base_url() . 'assets/docs/personal/' . $personal->foto_personal; ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <?php echo form_input('rfc', set_value('rfc', $personal->rfc), $data_rfc); ?>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <?php echo form_input('curp', set_value('curp', $personal->curp), $data_curp); ?>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <?php echo form_input('apellido_paterno', set_value('apellido_paterno', $personal->apellido_paterno), $data_apellido_paterno); ?>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <?php echo form_input('apellido_materno', set_value('apellido_materno', $personal->apellido_materno), $data_apellido_materno); ?>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <?php echo form_input('nombres', set_value('nombres', $personal->nombres), $data_nombres); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <?php echo form_input('fecha_ingreso', set_value('fecha_ingreso', $personal->fecha_ingreso), $data_fecha_ingreso); ?>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <?php echo form_dropdown('personal_contratos_id', $contratos, set_value('personal_contratos_id', $personal->personal_contratos_id), $data_contratos); ?>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <?php echo form_input('fecha_ultimo_ingreso', set_value('fecha_ultimo_ingreso', $personal->fecha_ultimo_ingreso), $data_fecha_ultimo_ingreso); ?>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <?php echo form_input('fecha_ultima_baja', set_value('fecha_ultima_baja', ($personal->fecha_ultima_baja == '0000-00-00') ? '' : $personal->fecha_ultima_baja), $data_fecha_ultima_baja); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('sexo', $generos, set_value('sexo', $personal->sexo), $data_genero); ?>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('estado_civil', $estados_civiles, set_value('estado_civil', $personal->estado_civil), $data_estado_civil); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('tipos_regimen_id', $tipos_regimen, set_value('tipos_regimen_id', $personal->tipos_regimen_id), $data_tipos_regimen); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('', $paises, $lugares_nacimiento[2]->cat_paises_id, $data_pais); ?>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('', $estados_nacimiento, $lugares_nacimiento[1]->cat_estados_id, $data_estado); ?>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('nacimiento_municipio_id', $municipios_nacimiento, set_value('nacimiento_municipio_id', $personal->nacimiento_municipio_id), $data_municipio); ?>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_input('fecha_nacimiento', set_value('fecha_nacimiento', $personal->fecha_nacimiento), $data_fecha_nacimiento); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('empresas_id', $empresas, $personal->empresas_id, $data_empresa); ?>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('registro_patronal_id', $registros_patronales, $personal->registro_patronal_id, $data_registro_patronal); ?>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('empresas_departamentos_id', $empresa_deptos, $personal->empresas_departamentos_id, $data_departamentos); ?>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('mano_de_obra_id', $puestos, set_value('mano_de_obra_id', $personal->mano_de_obra_id), $data_puesto); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('tipo_empleado', $tipo, set_value('tipo_empleado', $personal->tipo_empleado), $data_tipo); ?>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('turno', $turnos, set_value('turno', $personal->turno), $data_turnos); ?>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('obras_id', $obras_por_empresa, $personal->obras_id, $data_obras); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_input('tel_fijo', set_value('tel_fijo', $personal->tel_fijo), $data_tel_fijo); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_input('tel_movil', set_value('tel_movil', $personal->tel_movil), $data_tel_movil); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_input('email', set_value('email', $personal->email), $data_correo); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_input('direccion', set_value('direccion', $personal->direccion), $data_direccion); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('', $paises, $lugares_direccion[2]->cat_paises_id, $data_pais_domicilio); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('', $estados_direccion, $lugares_direccion[1]->cat_estados_id, $data_estado_domicilio); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('direccion_municipio_id', $municipios_direccion, $personal->direccion_municipio_id, $data_municipio_domicilio); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_input('salario_diario_imss', set_value('salario_diario_imss', $personal->salario_diario_imss), $data_salario_diario_imss); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_input('salario_diario_real', set_value('salario_diario_real', $personal->salario_diario_real), $data_salario_diario_real); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_input('no_imss', set_value('no_imss', $personal->no_imss), $data_no_imss); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_input('credito_infonavit', set_value('credito_infonavit', $personal->credito_infonavit), $data_credito_infonavit); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_input('credito_fonacot', set_value('credito_fonacot', $personal->credito_fonacot), $data_credito_fonacot); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('tipo_credito', $tipos_credito, set_value('tipo_credito', $personal->tipo_credito), $data_tipo_credito); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        <?php $data_porcentaje_numero = [
                                                            ...
                                                            'class' => 'form-control',
                                                            'data-rule-number' => 'true',
                                                            'data-msg-number' => trans_line('digits')
                                                        ]; ?>
                                                        <?php echo form_input('porcentaje_numero', set_value('porcentaje_numero', $personal->porcentaje_numero), $data_porcentaje_numero); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('cat_bancos_id', $bancos, set_value('cat_bancos_id', $personal->cat_bancos_id), $data_cat_bancos_id); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_input('bancos_sucursal', set_value('bancos_sucursal', $personal->bancos_sucursal), $data_bancos_sucursal); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_input('numero_cuenta', set_value('numero_cuenta', $personal->numero_cuenta), $data_numero_cuenta); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_input('clabe', set_value('clabe', $personal->clabe), $data_clabe); ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-md-line-input">
                                                        ...
                                                        <?php echo form_dropdown('periodo_de_pago_id', $periodos_pago, set_value('periodo_de_pago_id', $personal->periodo_de_pago_id), $data_periodo_pago); ?>
