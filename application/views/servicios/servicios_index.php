            ...
            <div class="page-content-inner">
                <div class="portlet light ">
                    <div class="portlet-body">
                        ...
                        <a href="<?php echo base_url_lang() . 'servicios/form_insert' ?>" class="btn btn-success btn_loading_page">
                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                            ...
                            <tbody>
                            <?php foreach ($rows as $servicio): ?>
                                <tr class="odd gradeX">
                                    <td> <?php echo $servicio->nombre; ?></td>
                                    <td>
                                        <a href="<?php echo base_url_lang() . 'servicios/form_edit/' . $servicio->servicios_id ?>"
                                        ...
                                        <a class="badge badge-danger badge-roundless delete_confirmation"
                                           ...
                                           data-id="<?php echo $servicio->servicios_id ?>">
...
<script type="application/javascript">
    $(document).ready(function () {
        ...
        $('.delete_confirmation').on('confirmed.bs.confirmation', function () {
            ...
            window.location.href = "<?php echo base_url_lang() . 'servicios/borrar_servicio/' ?>" + id;
        });
    });// FIN DOCUMENT READY
</script>