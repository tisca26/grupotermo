                    ...
                    <div class="portlet-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('precio_unitario', set_value('precio_unitario', $servicio->precio_unitario), 'id="precio_unitario" placeholder="' . trans_line('precio_unitario_placeholder') . '" class="form-control"'); ?>
