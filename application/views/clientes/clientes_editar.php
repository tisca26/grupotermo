    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="<?php echo base_url_lang() . 'clientes'; ?>"><?php echo trans_line('breadcrumb_clientes'); ?></a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
                    <span><?php echo trans_line('breadcrumb_clientes_editar'); ?></span>
                </li>
            </ul>
            ...
            <div class="page-content-inner">
                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        ...
                        <?php echo form_open('clientes/editar_cliente', array('id' => 'current_form')); ?>
                        <input type="hidden" name="clientes_id" value="<?php echo $cli->clientes_id; ?>">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('razon_social', set_value('razon_social', $cli->razon_social), 'id="razon_social" placeholder="' . trans_line('razon_social_placeholder') . '" class="form-control"'); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('rfc', set_value('rfc', $cli->rfc), 'id="rfc" placeholder="' . trans_line('rfc_placeholder') . '" class="form-control"'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('tel_fijo', set_value('tel_fijo', $cli->tel_fijo), 'id="tel_fijo" placeholder="' . trans_line('tel_fijo_placeholder') . '" class="form-control"'); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('email', set_value('email', $cli->email), 'id="email" placeholder="' . trans_line('email_placeholder') . '" class="form-control"'); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group form-md-line-input">
                                        <?php echo form_input('direccion', set_value('direccion', $cli->direccion), 'id="direccion" placeholder="' . trans_line('direccion_placeholder') . '" class="form-control"'); ?>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <a class="btn default"
                                       href="<?php echo base_url_lang() . 'clientes' ?>">Regresar</a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close(); ?>
