    ...
    <div class="page-content">
        <div class="container">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <span><?php echo trans_line('breadcrumb_clientes'); ?></span>
                </li>
            </ul>
            ...
            <div class="page-content-inner">
                <div class="portlet light ">
                    <div class="portlet-body">
                        ...
                        <a href="<?php echo base_url_lang() . 'clientes/form_insert' ?>" class="btn btn-success">
                            <i class="fa fa-plus"></i> <?php echo trans_line('agregar_cliente'); ?></a>
                        <hr>
                        <table class="table table-striped table-bordered table-hover table-checkable order-column"
                               id="users_table">
                            <thead>
                            <tr>
                                <th> <?php echo trans_line('cliente_tabla'); ?></th>
                                <th> <?php echo trans_line('contacto_tabla'); ?></th>
                                <th> <?php echo trans_line('acciones_tabla'); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php foreach ($rows as $cli): ?>
                                <tr class="odd gradeX">
                                    <td> <?php echo $cli->razon_social; ?></td>
                                    <td> <?php echo $cli->email; ?></td>
                                    <td>
                                        <a href="<?php echo base_url_lang() . 'clientes/form_edit/' . $cli->clientes_id ?>"
                                        ...
                                        <a class="badge badge-danger badge-roundless delete_confirmation"
                                           ...
                                           data-id="<?php echo $cli->clientes_id ?>">
...
<script type="application/javascript">
    $(document).ready(function () {
        ...
        $('.delete_confirmation').on('confirmed.bs.confirmation', function () {
            ...
            window.location.href = "<?php echo base_url_lang() . 'clientes/borrar_cliente/' ?>" + id;
        });
    });// FIN DOCUMENT READY
</script>